...
$permission = null;
$board_result = null;
$board_result = $db_conn->board_list_user($id);
...
<body class="d-flex h-100 text-center text-white bg-dark" style="background-attachment: fixed; background-repeat: no-repeat;">
                                    ...
                                    <div class="col shadow-sm" onclick="">
                                        <div class="board-container card shadow-sm h-100">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center card-footer bg-dark bg-opacity-75">
                                                ...
                                                <small class="text-muted">마지막 수정일 <?= $row['edit_date']  ?></small>
                                            </div>
                                        </div>
                                    </div>
                                <?php
